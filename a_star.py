# Módulo que implementa o algoritmo de busca A* - A Star
...
class A_Star:
    ...
    def criar_matriz_status_visita( self ):
        ...
        for i in range(numLinhas):
            linha = numColunas * [  A_Star.status_posicao['posicao_virgem']  ]
    ...
    def posicao_nao_foi_visitada( self, x, y ):
        return self.matriz_status_visita[y][x] == A_Star.status_posicao['posicao_virgem']                    
    ...
    def inserir_posicao_na_open_list( self, x, y, x_antecessor, y_antecessor ):  
        ...
        if( self.mapa.posicao_eh_valida( x, y ) and 
            ...
            self.matriz_status_visita[y][x] = A_Star.status_posicao['open_list']
    ...
    def pathfinder( self, posicao_inicial, posicao_final ):
        ...
        while( True ):
            ...
            self.matriz_status_visita[y][x] = A_Star.status_posicao['explorado']
